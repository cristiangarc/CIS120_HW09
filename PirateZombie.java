...
public class PirateZombie extends Zombie {
	private static String img_l = "Pirate_Zombie.png";
	private static String img_r = "Pirate_Zombie_Flipped.png";
	
	public static final int INIT_HEALTH = 8;
